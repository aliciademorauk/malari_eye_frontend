...
# this at least displays an image icon: st.image('https://github.com/aliciademorauk/malari_eye_frontend/blob/master/streamlit_malaria/images/Cell-Homepage2.png')
